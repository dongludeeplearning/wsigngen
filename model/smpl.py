...
class SMPL(_SMPLLayer):
    ...
    def forward(self, *args, **kwargs):
        smpl_output = super(SMPL, self).forward(*args, **kwargs)   #  smpl_output.vertices, smpl_output.joints
        ...
        for joinstype, indexes in self.maps.items():
            output[joinstype] = all_joints[:, indexes] # get 24 index   key change to "smpl"
...
class SMPLX(SMPLXLayer):
    ...
    def __init__(self, model_path=SMPLX_MODEL_PATH, **kwargs):
        ...
        kwargs["model_path"] = model_path    #'/home/lu/Research2/ACTOR/src/models/smpl3/SMPL_NEUTRAL.pkl' -->
    ...
    def forward(self, *args, **kwargs):
        ...
        # assign values 
        smplx_output = super(SMPLX, self).forward(*args, **kwargs)  # call parent class's forward method  
