...
def add_data_options(parser):
    ...
    group.add_argument("--dataset", default='humanml', choices=['humanml', 'kit', 'humanact12', 'uestc', 'wlasl30','wlasl_smplx100'], type=str,
                       help="Dataset name (choose from list).")
    group.add_argument("--data_dir", default="", type=str,
                       help="If empty, will use defaults according to the specified dataset.")
    group.add_argument("--cond_mode", default="text", choices=['action', 'text', 'description', 'a+d', 'a+t', 't+d'], type=str,
                       help="condition mode  (choose from list).")  # add our version
...
def get_cond_mode(args):
    if args.unconstrained:
        cond_mode = 'no_cond'
    elif args.dataset in ['kit', 'humanml']:  # use dataset name to decide the cond_mode; 
        cond_mode = 'text'
    elif args.dataset in ['wlasl30','wlasl_smplx100']:
        cond_mode =  args.cond_mode  #['action', 'text', 'description', 'a+d', 'a+t', 't+d']
    else:
        cond_mode = 'action'  
    return cond_mode
...
def generate_args():
    ...
    # if (args.input_text or args.text_prompt) and cond_mode != 'text' or 't+d':
