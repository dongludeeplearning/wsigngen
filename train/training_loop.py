...
from eval import eval_wsigngen
...
class TrainLoop:
    ...
    def evaluate(self):
        ...
        #     eval_dict = eval_wsigngen.evaluate(eval_args, model=self.model, diffusion=self.diffusion, data=self.data.dataset)
    ...
    def save(self):
        def save_checkpoint(params):
            ...
            log_message = f"{current_time} - Saving model to {self.save_dir+'/'+filename}\n"
            # Write the log message to a log file
            with open(self.save_dir+"/log.txt", "a") as log_file:
